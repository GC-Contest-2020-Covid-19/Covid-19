...
const ProgressionByCountrySelect = ({ allCountries, setUpFromDayOne, setUpallCountries }) => {
    ...
    return (
        <div className="custom-ml-5 custom-mr-5 custom-mt-3">
            <h2 className="is-size-2-desktop is-size-3-tablet is-size-4-mobile">
                Select a country to show progression
            </h2>
            <div className="select">
                <select value={value.country} onChange={handleChange} name="countries" id="countries">
            ...
            <div className="select">
                <select value={value.timeline} onChange={handleChange} name="timeline" id="countries">
...
export default connect(mapStateToProps, mapDispatchToProps)(ProgressionByCountrySelect);
