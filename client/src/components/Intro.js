					...
					<div className='columns is-vcentered has-text-centered'>
						...
						<div className='column has-text-black-bis'>
							<p className='is-size-2 is-size-4-mobile'>
								The last time a disease wreaked this level of havoc on the world
								was around century ago, so it's understandable that everyone is
								freaking out. But
								<span className='has-text-danger'> fear</span> never helped
								solve a problem
							</p>
						</div>
					</div>
