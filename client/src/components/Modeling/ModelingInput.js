        ...
        <div className="custom-ml-5 custom-mr-5 custom-mt-3">
            ...
            <form onSubmit={SubmitHandler} className="field ">
                ...
                <p className="label">
                    Healthy Population (
                    {s && population
                        ? s + "% - " + (population * (s / 100)).toLocaleString() + " People"
                        : "select a value"}
                    )
                </p>
                <div className="control">
                    <input
                        className="slider is-circle"
                        type="range"
                        min="0"
                        max="100"
                        step="0.01"
            ...
            {a && b ? (
                <p>
                    <a href="https://en.wikipedia.org/wiki/Basic_reproduction_number">basic reproduction number:</a>{" "}
                    {(a / b).toFixed(3)}
                </p>
            ) : null}
